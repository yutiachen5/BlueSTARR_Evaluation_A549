...
#                                main()
#=========================================================================
def main(configFile,subdir,modelFilestem,train_label):
    startTime=time.time()
    ...
    (X_train_sequence, X_train_seq_matrix, X_train, Y_train, idx_train) = \
        prepare_input(train_label,subdir,shouldRevComp,config.MaxTrain,config)
...
#=========================================================================
if(len(sys.argv)!=5):
    exit(ProgramName.get()+" <parms.config> <data-subdir> <out:model-filestem> <train-label>\n")
(configFile,subdir,modelFilestem,train_label)=sys.argv[1:]
main(configFile,subdir,modelFilestem,train_label)
